              ...
              children: [
                ...
                HomeOverviewPanel(
                  ...
                  actions: [
                    ...
                    HomeOverviewAction(label: display.text('boundingBox.title'), subtitle: display.text('home.action.boundingBox.subtitle'), icon: Icons.photo_outlined, onTap: AppNavigation.toBoundingBox),
