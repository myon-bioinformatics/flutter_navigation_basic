            ...
            child: Column(
              ...
              children: [
                ...
                if (_manualBox != null) ...[
                  ...
                  const SizedBox(height: 12),
                  _ResultCard(
                    title: t('coordinate.looseBox'),
                    value: _manualBox!.labeledText,
                    copyTooltip: t('common.copy'),
                    onCopy: () => _copy(_manualBox!.labeledText, t('coordinate.looseBox')),
                  ),
                  const SizedBox(height: 12),
                  _ResultCard(
                    title: t('coordinate.bbox'),
                    value: _manualBox!.bboxText,
                    copyTooltip: t('common.copy'),
                    onCopy: () => _copy(_manualBox!.bboxText, t('coordinate.bbox')),
                  ),
                  const SizedBox(height: 12),
                  _ResultCard(
                    title: t('coordinate.json'),
                    value: _manualBox!.jsonText,
                    copyTooltip: t('common.copy'),
                    onCopy: () => _copy(_manualBox!.jsonText, t('coordinate.json')),
                  ),
                ],
