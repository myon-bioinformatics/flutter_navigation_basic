...
class _CoordinateToolPageState extends State<CoordinateToolPage> {
  ...
  Future<void> _copy(String value) async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('Copied coordinates.')),
    );
  }
        ...
        child: Center(
          child: ConstrainedBox(
            ...
            child: Column(
              ...
              children: [
                Text(
                  'Convert decimal latitude and longitude into a normalized DMS representation.',
                ...
                if (value != null) ...[
                  ...
                  _ResultCard(
                    ...
                    onCopy: () => _copy(value.decimalDegrees),
                  ),
                  const SizedBox(height: 12),
                  _ResultCard(
                    title: 'Degrees / minutes / seconds (DMS)',
                    value: value.dms,
                    onCopy: () => _copy(value.dms),
                  ),
                  const SizedBox(height: 12),
                  Text(
                    'Hemisphere: latitude uses N/S; longitude uses E/W. '
                    'No map, geocoding service, server, or database is used.',
