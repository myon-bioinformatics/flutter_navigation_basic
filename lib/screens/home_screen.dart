              ...
              children: [
                ...
                HomeOverviewPanel(
                  ...
                  actions: [
                    ...
                    HomeOverviewAction(label: display.text('photoStudio.title'), subtitle: display.text('home.action.photoStudio.subtitle'), icon: Icons.photo_outlined, onTap: () => Navigator.pushNamed(context, AppRoutes.photoStudio)),
                    ...
                    HomeOverviewAction(label: display.text('httpDraft.title'), subtitle: display.text('home.action.httpRequestDraft.subtitle'), icon: Icons.http_outlined, onTap: () => Navigator.pushNamed(context, AppRoutes.httpRequestDraft)),
